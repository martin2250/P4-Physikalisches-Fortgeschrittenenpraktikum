...
\begin{figure}
	\centering
	\includegraphics[width=.5\textwidth]{./img/cryostat.pdf}
	\captiond{The cryostat used in this experiment}{The sample chamber enclosed by a superconducting coil is visible in the center. Both dewars are thermally insulated by a double-walled design. Source: Lab manual}
\end{figure}
