...
\begin{figure}
	\centering
	\includegraphics[width=.6\textwidth]{./data/plots/calibration.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=.5\textwidth]{./data/plots/diff-cross-sec.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=.5\textwidth]{./data/plots/energy-shift.pdf}
