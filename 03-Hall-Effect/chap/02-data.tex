...
\begin{figure}
  ...
  \captiond{Product of conductivity and Hall coefficient over temperature of sample A}{the solid line shows the border between intrinsic and transition regions, the dashed line shows the border between transition and extrinsic regions}
