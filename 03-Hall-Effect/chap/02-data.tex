...
The value of $n_\text{i}\left(T = \SI{300}{\kelvin}\right)$ is obtained by (a linear interpolation between the closest measured values) or (fitting a polynomial (or similar) to all values of $n_\text{i}$)
