...
$\Delta\left(\frac{1}{B}\right)$ is obtained via linear regression of form $\frac{1}{B_\text{peaks}} = \Delta\left(\frac{1}{B}\right)\cdot i + b$, where $i\in\mathbb{N}_0$ \todo{along the lines of is the index of the corresponding plateau, where the absolute value of i doesn't matter}.
...
\end{align*}
with a (rather low)\todo{keep this?} standard deviation of \SI{1.31e10}{\per\meter\squared}.
